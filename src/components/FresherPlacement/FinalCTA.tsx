    ...
    <section className="py-28 bg-brand-950 relative overflow-hidden text-center border-t border-brand-900">
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-12 relative z-10">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={scaleUp}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold text-white mb-6">Placement timelines move quickly.</h2>
          ...
          <motion.button whileHover={{ scale: 1.05, boxShadow: "0 0 50px -10px rgba(34, 197, 94, 0.6)" }} whileTap={{ scale: 0.95 }} className="px-8 md:px-12 py-4 md:py-5 rounded-full bg-[#22c55e] text-black font-bold text-lg shadow-glow-green transition-all">Start Learning</motion.button>
        </motion.div>
      </div>
    </section>
  );
