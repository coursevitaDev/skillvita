                    ...
                    <div className="bg-[#18181B] rounded-2xl p-8 border border-[#27272A] shadow-lg">
                        <div className="flex items-start gap-4">
                            <div className="flex-shrink-0 mt-1">
                                <div className="w-10 h-10 rounded-full bg-purple-900/30 flex items-center justify-center text-purple-400 font-bold text-xl">
                                    Q
                                </div>
                            </div>
                            <div className="flex-grow">
                                ...
                                <div className="bg-black/40 rounded-xl p-6 border border-gray-800">
                                    <div className="flex items-start gap-4">
                                        <div className="flex-shrink-0 mt-1">
                                            <div className="w-8 h-8 rounded-full bg-purple-900/30 flex items-center justify-center text-purple-400 font-bold text-sm">
                                                A
                                            </div>
                                        </div>
                                        <div>
                                            <p className="text-gray-300">
                                                ...
                                                <span className="block mt-2 text-sm text-purple-400 font-medium">
                                                    ✓ Accepted Answer
                                                </span>
                                            </p>
                                        </div>
